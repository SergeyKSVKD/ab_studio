...
const AboutTeam = () => {
    ...
    return <section className={styles.container}>
        ...
        <div className={cn(styles.text, styles.text_block1)}>
            ...
            <p>Меня зовут Иван и я основатель студии ремонта <span className={styles.text_color}>премиум класса</span> Design studio.</p>
            ...
            <p>Помимо основной деятельности по отделке квартир и коттеджей, а с 2002 года мной сдано <span className={styles.text_color}>более 50 000 квадратных метров</span>, я занимаюсь консультацией при приемке квартир. За несколько лет принято у застройщика <span className={styles.text_color}>более 2300 квартир</span>, что дает огромный уровень насмотренности и позволяет применять этот опыт при проектировании.</p>
            <p>На своем <span className={styles.text_color}>YouTube канале</span>, я делаю обзоры новостроек, что позволит вам без проблем выбрать себе застройщика, узнав у кого из застройщиков какой подход к строительству. Кстати на канале <Link className={cn(styles.link, styles.text_color)} href='https://youtube.com/@xxxxxxx'>уже более 10,91+ млн просмотров, присоединяйтесь! <TfiYoutube /></Link></p>
        </div>
